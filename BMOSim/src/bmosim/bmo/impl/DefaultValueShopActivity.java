 ...
 * Source Class: DefaultValueShopActivity <br>
 * @version generated on Thu Oct 26 02:05:01 WAT 2017 by Hichem
 */
public abstract class DefaultValueShopActivity extends WrappedIndividualImpl implements ValueShopActivity {

    public DefaultValueShopActivity(OWLOntology ontology, IRI iri) {
    ...
    public Collection<? extends Object> getValueShopActivityNature() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_VALUESHOPACTIVITYNATURE, Object.class);
    }

    public boolean hasValueShopActivityNature() {
		return !getValueShopActivityNature().isEmpty();
    }

    public void addValueShopActivityNature(Object newValueShopActivityNature) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_VALUESHOPACTIVITYNATURE, newValueShopActivityNature);
    }

    public void removeValueShopActivityNature(Object oldValueShopActivityNature) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_VALUESHOPACTIVITYNATURE, oldValueShopActivityNature);
    }
