...
public interface Actor extends BMElement {

    /* ***************************************************
     * Property http://www.owl-ontologies.com/unnamed.owl#isRelatedVia
     */
     
    /**
     * Gets all property values for the isRelatedVia property.<p>
     * 
     * @returns a collection of values for the isRelatedVia property.
     */
    Collection<? extends PartnershipAgreement> getIsRelatedVia();

    /**
     * Checks if the class has a isRelatedVia property value.<p>
     * 
     * @return true if there is a isRelatedVia property value.
     */
    boolean hasIsRelatedVia();

    /**
     * Adds a isRelatedVia property value.<p>
     * 
     * @param newIsRelatedVia the isRelatedVia property value to be added
     */
    void addIsRelatedVia(PartnershipAgreement newIsRelatedVia);

    /**
     * Removes a isRelatedVia property value.<p>
     * 
     * @param oldIsRelatedVia the isRelatedVia property value to be removed.
     */
    void removeIsRelatedVia(PartnershipAgreement oldIsRelatedVia);
